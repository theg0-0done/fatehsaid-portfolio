export const styles = {
  profile: {
    ...
    contactBtn:
      "hover:bg-gray-800 whitespace-nowrap flex justify-center items-center hover:text-white md:text-xl px-2 lg:px-8 py-2 lg:py-4 rounded-4xl cursor-pointer bg-transparent text-black border-2 border-gray-600 transition-all duration-300 ease-in-out ",
    resumeBtn:
      "bg-gray-800 whitespace-nowrap flex justify-center items-center text-white md:text-xl px-2 lg:px-8 py-2 lg:py-4  rounded-4xl cursor-pointer hover:bg-transparent hover:text-black border-2 border-transparent hover:border-gray-600 transition-all duration-300 ease-in-out ",
    hamList:
